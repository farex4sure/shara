			...
			<div class="relative">
				<div class="flex justify-between px-5 py-4 text-xl items-center bg-green-500 text-white fixed top-0 w-full">
					...
					<div class="space-x-5">
						...
						<i
							class="fa-solid fa-language language cursor-pointer"
							onClick={handleLanguage}
						></i>
					</div>
					<div
						class={`absolute bg-white px-5 rounded py-3 text-green-600 text-sm right-5 top-14 language-bar ${
				...
				<div class="flex space-x-5 justify-around px-5 bg-white py-2 items-center fixed bottom-0 w-full border-y-green-500 debug">
